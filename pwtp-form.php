...
// contact form
	...
	<div class="form-group pwtp-problem-group">
		...
		<input type="text" name="pwtp_problem" id="pwtp_name" '.(isset($error_class['form_name']) ? ' class="form-control pwtp-error"' : ' class="form-control"').' value="'.esc_attr($form_data['form_name']).'" />
	</div>
