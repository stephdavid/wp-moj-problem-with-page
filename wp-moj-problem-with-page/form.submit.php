...
$errors[]=$hname.' should be at least '
.$rule['minlength'].' characters in length.';
...
echo '</li></ul><a href="moj-problem-with-page.php"><p>Please go back and correct your errors.</p></a>';
}
?>
