...
<!--
 ...
 -->
	...
	<fieldset>
			...
			<label for="problem">What were you doing and what went wrong? (This information must be provided)</label><br>
	  		<textarea rows="6" cols="100" name="problem" id="problem"></textarea><br>
			<label for="improve">What could we improve?</label><br>
	  		<textarea rows="6" cols="100" name="improve" id="improve"></textarea><br>
		</fieldset>
